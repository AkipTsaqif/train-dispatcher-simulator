...
export const JATINEGARA_PIECES: PieceSet = {
	pieces: [
		...
		{ kind: "signal", id: "NW1", groupId: "t1", x: 112, facing: "toward-to", mount: "up", label: "NW1", protectedBlockSectionId: "section-NW1" },
		{ kind: "signal", id: "NW1A", groupId: "t1", x: 304, facing: "toward-to", mount: "up", label: "NW1A", protectedBlockSectionId: "section-NW1A" },
		{ kind: "signal", id: "NW3", groupId: "t3", x: 160, facing: "toward-to", mount: "up", label: "NW3", protectedBlockSectionId: "section-NW3" },
		{ kind: "signal", id: "NW5", groupId: "t6", x: 160, facing: "toward-to", mount: "up", label: "NW5", protectedBlockSectionId: "section-NW5" },
		...
		{ kind: "signal", id: "BJ2", groupId: "mtr_hilir", x: 160, facing: "toward-from", mount: "up", label: "BJ2", protectedBlockSectionId: "section-BJ2", block: true },
		{ kind: "signal", id: "MAS", groupId: "mtr_hilir", x: 64, facing: "toward-from", mount: "up", label: "MAS", protectedBlockSectionId: "section-MAS", block: true },
		// Hulu (lower row, eastbound ->): BM1 at 160 (cell 8, facing right)
		{ kind: "signal", id: "BM1", groupId: "mtr_hulu", x: 160, facing: "toward-to", mount: "down", label: "BM1", protectedBlockSectionId: "section-BM1", block: true },
		...
		{ kind: "signal", id: "B208", groupId: "t7", x: 64, facing: "toward-from", mount: "up", label: "B208", protectedBlockSectionId: "section-B208", block: true },
		{ kind: "signal", id: "B207", groupId: "pok_hilir", x: 272, facing: "toward-from", mount: "up", label: "B207", protectedBlockSectionId: "section-B207", block: true },
		...
		{ kind: "signal", id: "J102", groupId: "pok_hulu", x: 272, facing: "toward-to", mount: "down", label: "J102", protectedBlockSectionId: "section-J102", block: true },
		{ kind: "signal", id: "J101", groupId: "pok_hulu", x: 368, facing: "toward-to", mount: "down", label: "J101", protectedBlockSectionId: "section-J101", block: true },
		...
		{ kind: "signal", id: "K11", groupId: "kld_t1", x: 464, facing: "toward-to", mount: "down", label: "K11", protectedBlockSectionId: "section-K11", block: true },
		{ kind: "signal", id: "K12", groupId: "kld_t1", x: 512, facing: "toward-to", mount: "down", label: "K12", protectedBlockSectionId: "section-K12", block: true },
		{ kind: "signal", id: "K13", groupId: "kld_t1", x: 560, facing: "toward-to", mount: "down", label: "K13", protectedBlockSectionId: "section-K13", block: true },
		{ kind: "signal", id: "K14", groupId: "kld_t1", x: 608, facing: "toward-to", mount: "down", label: "K14", protectedBlockSectionId: "section-K14", block: true },
		{ kind: "signal", id: "K15", groupId: "kld_t1", x: 656, facing: "toward-to", mount: "down", label: "K15", protectedBlockSectionId: "section-K15", block: true },
		{ kind: "signal", id: "K16", groupId: "kld_t1", x: 704, facing: "toward-to", mount: "down", label: "K16", protectedBlockSectionId: "section-K16", block: true },
		{ kind: "signal", id: "K17", groupId: "kld_t1", x: 752, facing: "toward-to", mount: "down", label: "K17", protectedBlockSectionId: "section-K17", block: true },
		...
		{ kind: "signal", id: "K21", groupId: "kld_t2", x: 752, facing: "toward-from", mount: "down", label: "K21", protectedBlockSectionId: "section-K21", block: true },
		{ kind: "signal", id: "K22", groupId: "kld_t2", x: 704, facing: "toward-from", mount: "down", label: "K22", protectedBlockSectionId: "section-K22", block: true },
		{ kind: "signal", id: "K23", groupId: "kld_t2", x: 656, facing: "toward-from", mount: "down", label: "K23", protectedBlockSectionId: "section-K23", block: true },
		{ kind: "signal", id: "K24", groupId: "kld_t2", x: 608, facing: "toward-from", mount: "down", label: "K24", protectedBlockSectionId: "section-K24", block: true },
		{ kind: "signal", id: "K25", groupId: "kld_t2", x: 560, facing: "toward-from", mount: "down", label: "K25", protectedBlockSectionId: "section-K25", block: true },
		{ kind: "signal", id: "K26", groupId: "kld_t2", x: 512, facing: "toward-from", mount: "down", label: "K26", protectedBlockSectionId: "section-K26", block: true },
		{ kind: "signal", id: "K27", groupId: "kld_t2", x: 464, facing: "toward-from", mount: "down", label: "K27", protectedBlockSectionId: "section-K27", block: true },
		// t3 Hulu FAST (eastbound ->): blocks at cells 2,7,12,17 (mounted UP)
		{ kind: "signal", id: "K31", groupId: "kld_t3", x: 464, facing: "toward-to", mount: "up", label: "K31", protectedBlockSectionId: "section-K31", block: true },
		{ kind: "signal", id: "K32", groupId: "kld_t3", x: 544, facing: "toward-to", mount: "up", label: "K32", protectedBlockSectionId: "section-K32", block: true },
		{ kind: "signal", id: "K33", groupId: "kld_t3", x: 624, facing: "toward-to", mount: "up", label: "K33", protectedBlockSectionId: "section-K33", block: true },
		{ kind: "signal", id: "K34", groupId: "kld_t3", x: 704, facing: "toward-to", mount: "up", label: "K34", protectedBlockSectionId: "section-K34", block: true },
		// t4 Hilir FAST (westbound <-): mirrored, blocks at cells 20,15,10,5
		{ kind: "signal", id: "K41", groupId: "kld_t4", x: 752, facing: "toward-from", mount: "up", label: "K41", protectedBlockSectionId: "section-K41", block: true },
		{ kind: "signal", id: "K42", groupId: "kld_t4", x: 672, facing: "toward-from", mount: "up", label: "K42", protectedBlockSectionId: "section-K42", block: true },
		{ kind: "signal", id: "K43", groupId: "kld_t4", x: 592, facing: "toward-from", mount: "up", label: "K43", protectedBlockSectionId: "section-K43", block: true },
		{ kind: "signal", id: "K44", groupId: "kld_t4", x: 512, facing: "toward-from", mount: "up", label: "K44", protectedBlockSectionId: "section-K44", block: true },
