...
export const JATINEGARA_PIECES: PieceSet = {
	pieces: [
		...
		{ kind: "link", id: "xov1", from: [288, 496], to: [320, 464] },
		{ kind: "link", id: "xov2", from: [336, 464], to: [368, 432] },
		{ kind: "link", id: "xov3", from: [384, 432], to: [416, 400] },
		{ kind: "link", id: "xov4", from: [384, 400], to: [416, 432] },
		{ kind: "link", id: "xov5", from: [464, 496], to: [496, 464] },
		{ kind: "link", id: "xov6", from: [464, 464], to: [496, 496] },
		{ kind: "link", id: "xov7", from: [384, 336], to: [448, 400] },
		{ kind: "link", id: "xov8", from: [336, 336], to: [368, 304] },
		{ kind: "link", id: "xov9", from: [336, 304], to: [368, 336] },
		{ kind: "link", id: "xov10", from: [448, 336], to: [480, 368] },
		{ kind: "link", id: "xov11", from: [464, 400], to: [496, 368] },
		{ kind: "link", id: "xov12", from: [448, 304], to: [480, 272] },
		{ kind: "link", id: "xov13", from: [592, 272], to: [624, 304] },
		{ kind: "link", id: "xov14", from: [592, 368], to: [624, 336] },
		// Split at AL7 [608,352] for the inverted point at t5y's west end.
		{ kind: "link", id: "xov15", from: [640, 336], to: [704, 400], splitAt: [656, 352] },
		{ kind: "link", id: "xov16", from: [656, 304], to: [752, 400] },
		// Split at AT7 [736,352] for the inverted point at t5y's east end.
		{ kind: "link", id: "xov18", from: [688, 304], to: [752, 368], splitAt: [736, 352] },
		{ kind: "link", id: "xov19", from: [720, 400], to: [752, 432] },
		{ kind: "link", id: "xov20", from: [768, 400], to: [800, 432] },
		{ kind: "link", id: "xov21", from: [768, 432], to: [800, 464] },
		{ kind: "link", id: "xov22", from: [816, 432], to: [848, 464] },
		{ kind: "link", id: "xov23", from: [816, 464], to: [848, 496] },
		{ kind: "link", id: "xov24", from: [864, 432], to: [896, 400] },
		{ kind: "link", id: "xov25", from: [864, 464], to: [896, 496] },
		{ kind: "link", id: "xov26", from: [672, 464], to: [704, 432] },
		// Split at BI8 so the inverted point P57 can sit mid-diagonal. The halves
		// are derived, so moving this link moves the point with it.
		{ kind: "link", id: "xov27", from: [912, 400], to: [976, 336], splitAt: [944, 368] },
		{ kind: "link", id: "xov30", from: [976, 336], to: [1040, 272] },
		{ kind: "link", id: "xov31", from: [992, 336], to: [1024, 368] },
		{ kind: "link", id: "xov32", from: [1040, 368], to: [1072, 336] },
		{ kind: "link", id: "xov28", from: [912, 432], to: [944, 400] },
		{ kind: "link", id: "xov29", from: [960, 400], to: [992, 368] },
		...
		{ kind: "signal", id: "NW1", groupId: "t1", x: 256, facing: "toward-to", mount: "up", label: "NW1", protectedBlockSectionId: "section-NW1" },
		{ kind: "signal", id: "NW3", groupId: "t3", x: 304, facing: "toward-to", mount: "up", label: "NW3", protectedBlockSectionId: "section-NW3" },
		{ kind: "signal", id: "NW5", groupId: "t6", x: 304, facing: "toward-to", mount: "up", label: "NW5", protectedBlockSectionId: "section-NW5" },
		{ kind: "signal", id: "NW7", groupId: "t8", x: 432, facing: "toward-to", mount: "up", label: "NW7", protectedBlockSectionId: "section-NW7" },
		{ kind: "signal", id: "NE2", groupId: "t2", x: 928, facing: "toward-from", mount: "up", label: "NE2", protectedBlockSectionId: "section-NE2" },
		{ kind: "signal", id: "NE4", groupId: "t4", x: 1008, facing: "toward-from", mount: "up", label: "NE4", protectedBlockSectionId: "section-NE4" },
		{ kind: "signal", id: "NE5", groupId: "t5ap", x: 1088, facing: "toward-from", mount: "up", label: "NE5", protectedBlockSectionId: "section-NE5" },
		{ kind: "signal", id: "NE6", groupId: "t6am", x: 1088, facing: "toward-from", mount: "up", label: "NE6", protectedBlockSectionId: "section-NE6" },
		// On the xov30 diagonal at BK4 - its exact midpoint. A diagonal needs the
		...
		{ kind: "signal", id: "XW2", groupId: "t2", x: 512, facing: "toward-from", mount: "up", label: "XW2", protectedBlockSectionId: "section-XW2" },
		{ kind: "signal", id: "XW3", groupId: "t3", x: 512, facing: "toward-from", mount: "up", label: "XW3", protectedBlockSectionId: "section-XW3" },
		{ kind: "signal", id: "XW4", groupId: "t4", x: 512, facing: "toward-from", mount: "up", label: "XW4", protectedBlockSectionId: "section-XW4" },
		{ kind: "signal", id: "XW5", groupId: "t5", x: 512, facing: "toward-from", mount: "up", label: "XW5", protectedBlockSectionId: "section-XW5" },
		{ kind: "signal", id: "XW6", groupId: "t6", x: 512, facing: "toward-from", mount: "up", label: "XW6", protectedBlockSectionId: "section-XW6" },
		{ kind: "signal", id: "XW7", groupId: "t7", x: 512, facing: "toward-from", mount: "up", label: "XW7", protectedBlockSectionId: "section-XW7" },
		{ kind: "signal", id: "XW8", groupId: "t8", x: 512, facing: "toward-from", mount: "up", label: "XW8", protectedBlockSectionId: "section-XW8" },
		...
		{ kind: "signal", id: "XE5", groupId: "t5", x: 592, facing: "toward-to", mount: "up", label: "XE5", protectedBlockSectionId: "section-XE5" },
		{ kind: "signal", id: "XE6", groupId: "t6", x: 592, facing: "toward-to", mount: "up", label: "XE6", protectedBlockSectionId: "section-XE6" },
		{ kind: "signal", id: "XE7", groupId: "t7", x: 592, facing: "toward-to", mount: "up", label: "XE7", protectedBlockSectionId: "section-XE7" },
		{ kind: "signal", id: "XE8", groupId: "t8", x: 592, facing: "toward-to", mount: "up", label: "XE8", protectedBlockSectionId: "section-XE8" },
		...
		{ kind: "platform", stationCode: "JNG", groupId: "t5", x: 560 },
		...
		{ kind: "platform", stationCode: "JNG-W", groupId: "t5", x: 488 },
		...
		{ kind: "platform", stationCode: "JNG-E", groupId: "t5ac", x: 936 },
		{ kind: "platform", stationCode: "JNG-W", groupId: "t5y", x: 664 },
		{ kind: "platform", stationCode: "JNG-E", groupId: "t5y", x: 680 },
	],
	...
	switchMeta: {
		...
		// INVERTED point at BI6: the diagonal runs straight through to BM2, the
